            ...
            <div class="flex-auto p-6">
                ...
                <form role="form text-left" action="/owner/penjualan/tambah_produk <?= $id_penjualan ? '?id_trx=' . $id_penjualan : '' ?>" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="date" name="tanggal_penjualan" value="<?= $id_penjualan ? date('Y-m-d', strtotime($penjualan['tanggal'])) : date('Y-m-d') ?>" required class="text-sm focus:shadow-soft-primary-outline leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow" placeholder="Nama Bahan">
                    </div>
                    <div class="mb-4">
